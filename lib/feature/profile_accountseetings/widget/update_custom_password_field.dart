...
class UpdatePasswordFiled extends StatelessWidget {
  final UpdatePasswordController updatePasswordController = Get.find<UpdatePasswordController>();

   UpdatePasswordFiled({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final strength = updatePasswordController.passwordStrength.value;
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      obscureText: !updatePasswordController.isPasswordVisible.value,
                  ...
                  GestureDetector(
                    onTap: updatePasswordController.toggleVisibility,
                    child: Icon(
                      updatePasswordController.isPasswordVisible.value
                          ? Icons.visibility
