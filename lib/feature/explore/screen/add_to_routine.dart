...
class AddToRoutine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (passedProductId != null && controller.productId.value.isEmpty) {
      controller.setProductId(passedProductId);
    }
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(controller.visibleOrders.value, (index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              if (controller.selectedOrder.value == number) {
                                controller.selectedOrder.value = 0;
                              } else {
                                controller.selectedOrder.value = number;
                              }
                            },
                            child: Container(
                              decoration: BoxDecoration(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(controller.visibleEvening.value, (index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              if (controller.selectedEveningOrder.value == number) {
                                controller.selectedEveningOrder.value = 0;
                              } else {
                                controller.selectedEveningOrder.value = number;
                              }
                            },
                            child: Container(
                              decoration: BoxDecoration(
                    ...
                    Obx(() {
                      ...
                      return Expanded(
                        child: CustomButton(
                          ...
                          color: enabled
                              ? const Color(0xff172601)
                              : const Color(0xffA0A09F),
                          onTap: !enabled
                              ? () {}
                              : () {
                                  ProgressDialog.show(context, controller);
                                  controller.submitRoutine();
                                },
                        ),
                      );
