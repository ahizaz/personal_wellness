              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white.withOpacity(0.8), // Adjust opacity or color to match the light background in the image
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color:Color(0xff172601), // Assuming "View all" is clickable or highlighted
                            ),
                          ),
                        ],
                      ),
                    ...
                    SizedBox(height: 16.h,),
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                            Text("Before & After",style: TextStyle(
                              fontFamily: "SFPro",
                              fontSize: 17.sp,
                              fontWeight: FontWeight.w600,
                            ...
                            SizedBox(height: 4.h,),
                            Text("Slide to compare your transformation",style: TextStyle(
                                fontFamily: "SFPro",
                              fontSize: 14.sp,
                            ...
                            Row(
                              children: [
                                SizedBox(
                                  width: 99.w,
                                  height: 220.h,
                                  child: Image(image: AssetImage(ImagePath.beforeafterimage1),fit: BoxFit.cover,),
                                ),
                                SizedBox(width: 2.w,),
                                SizedBox(
                                  width: 99.w,
                                  height: 220.h,
                                   child: Image(image: AssetImage(ImagePath.beforeafterimage2),fit: BoxFit.cover,),
                                  
                                ),
                                SizedBox(
                                  width: 14.w,
                                  height: 230.h,
                                  child: Image(image: AssetImage(ImagePath.bamboo),fit: BoxFit.cover,),
                                ),
                                SizedBox(
                                  width: 125.w,
                                  height: 220.h,
                                  child: Image(image: AssetImage(ImagePath.beforeafterimage3),fit: BoxFit.cover,),
                                )
                              ],
                            ),
                            SizedBox(height: 4.h,),
                            ...
                            SizedBox(height: 4.h,),
                             Row(
                              children: [
                                Text("15 Jan 2025",style: TextStyle(
                                  fontFamily: "SFPro",
                                  fontSize: 17.sp,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xff172601),
                                ...
                                Spacer(),
                                 Text("15 Mar 2025",style: TextStyle(
                                  fontFamily: "SFPro",
                                  fontSize: 17.sp,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xff172601),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Update your Progress",style: TextStyle(
                                    fontFamily: "SFPro",
                                    fontSize: 17.sp,
                                    fontWeight: FontWeight.w500,
                                    color: Color(0xff172601)
                                  ...
                                  SizedBox(height: 8.h,),
                                  Text("Take your progress photo to\ntrack your skin journey",style: TextStyle(
                                    fontFamily: "SFPro",
                                    fontSize: 16,
                                    fontWeight: FontWeight.w400,
                     ...
                     Spacer(),
                           Container(
                            ...
                            child: Image(image: AssetImage(ImagePath.progressimageback),fit: BoxFit.cover,),
                           )
                          ],
                        ),
                      ),
